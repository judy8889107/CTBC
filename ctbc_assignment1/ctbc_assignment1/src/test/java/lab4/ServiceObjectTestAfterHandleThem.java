...
import util.CourseServiceFactory;

public class ServiceObjectTestAfterHandleThem {
	public static void main(String[] args) {
		CourseServiceFactory factory = CourseServiceFactory.getInstance();
		CourseCategoryServiceJDKImplement categoryService = factory.getCategoryService();
		CourseServiceJDKImplement courseService = factory.getCourseService();
